...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1c2544] text-white">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
        {/* Top Section - Logo and Navigation Row */}
        <div className="grid grid-cols-1 lg:grid-cols-[225px_1fr_auto] gap-6 lg:gap-12 mb-8">
          {/* Logo */}
          ...
          {/* Navigation - Aligned with bottom of logo */}
            ...
            <nav className="flex flex-wrap items-center gap-6 md:gap-10">
              {NAV_ITEMS.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-[21.333px] font-normal transition-colors hover:opacity-80 tracking-[-0.2133px]"
          ...
          {/* Contact Header - Right, aligned with bottom */}
          <div className="flex items-end">
            <h3 className="text-[21.333px] font-medium tracking-[-0.2133px]" style={{ fontVariationSettings: "'wdth' 100" }}>
              Entre em contato
            </h3>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[225px_1fr_auto] gap-6 lg:gap-12 mb-12">
          {/* Empty space to align with logo */}
          <div className="hidden lg:block"></div>

          {/* Newsletter - Starts under "Home" */}
          <div className="max-w-md">
            <h3 className="text-[32px] font-medium leading-normal mb-4" style={{ fontVariationSettings: "'wdth' 100" }}>
              Não Perca <br />
              Nenhuma Oportunidade.
            </h3>
            <p className="text-[18px] font-light leading-[30px] mb-6 opacity-90">
          ...
          {/* Contact Details - Aligned with right */}
          <div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="grid grid-cols-1 lg:grid-cols-[225px_1fr_auto] gap-6 lg:gap-12 items-center">
            ...
            <div className="flex items-center gap-6 text-[16px] opacity-60 tracking-[-0.16px]" style={{ fontVariationSettings: "'wdth' 100" }}>
