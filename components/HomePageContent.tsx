        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div
              ...
              style={{ backgroundImage: 'linear-gradient(to right bottom, #7c3aed, #5b21b6)' }}
            >
              <div className="absolute top-4 right-4 z-10">
                <span className="bg-white text-purple-800 text-sm font-semibold px-3 py-1 rounded-full">
                  {t("products.webinarIA.tag")}
                </span>
              </div>
              <div className="p-8 lg:p-10 text-white flex flex-col flex-1">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold mb-4 text-white">
                  {t("products.webinarIA.title")}
                </h3>
                <p className="text-lg mb-6 text-white opacity-95 leading-relaxed flex-1">
                  {t("products.webinarIA.description")}
                </p>
                <Button variant="secondary" size="lg" className="w-full mt-auto border-white/30 hover:bg-white/90" asChild>
                  <Link href={EXTERNAL_URLS.webinarIA} target="_blank" rel="noopener noreferrer">
                    {t("products.webinarIA.button")}
                  </Link>
                </Button>
              </div>
              <div className="relative h-[250px]">
                <Image
                  ...
                  alt="Webinar IA – O futuro das empresas"
                  fill
                  className="object-cover"
                />
              </div>
