      ...
      <Section className="py-20">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Contact Information */}
            <div>
              <h2 className="text-4xl font-bold text-[#1c2544] mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-[#1c2544]">
                      {t("contactPage.info.address.label")}
                    </h3>
              ...
              <div className="mt-10 p-8 bg-[#f3f9f0] rounded-2xl">
                <div className="flex items-start">
                  <svg
                    className="w-8 h-8 text-[#87c76c] mr-4 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2 text-[#1c2544]">
                      {t("contactPage.info.fastResponse.title")}
                    </h3>
                    <p className="text-gray-600 text-lg leading-relaxed">
                      {t("contactPage.info.fastResponse.description")}
                    </p>
                  </div>
                </div>
              </div>
